...
<link rel="stylesheet" href="{{url('/')}}/design/admin/bower_components/font-awesome/css/font-awesome.min.css">
 ...
 @else
 <link rel="stylesheet" href="{{url('/')}}/design/admin/css/rtl/AdminLTE.min.css">
 <link rel="stylesheet" href="{{url('/')}}/design/admin/css/rtl/bootstrap-rtl.min.css">
 <link rel="stylesheet" href="{{url('/')}}/design/admin/css/rtl/rtl.css">
 @endif
 ...
 <link rel="stylesheet" href="{{url('/')}}/design\admin\src\themes\default\style.css">
  ...
  <link rel="stylesheet" href="{{url('/')}}/design/admin/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  ...
  <link rel="stylesheet" href="{{url('/')}}/design/admin/css/style.css">
  <!-- Google Font -->
