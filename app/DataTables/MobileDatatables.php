...
class MobileDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.mobile.btn.checkbox')
            ->addColumn('edit', 'admin.mobile.btn.edit')
            ->addColumn('delete', 'admin.mobile.btn.delete')
            ->addColumn('mobile_image', function($query){

                $url = asset('storage/'.$query->mobile_image); 
    ...
    protected function getColumns()
    {
        return [
            ...
            'name' => 'mobile_image',
            'data' => 'mobile_image',
            'title' => trans('admin.mobile_image'),
           ],[
            'name'  => 'edit',
            'data'  => 'edit',
    ...
    {
        return 'MobileDatatables.php_' . date('YmdHis');
    }
}
