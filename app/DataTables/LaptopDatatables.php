...
class LaptopDatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('checkbox', 'admin.laptop.btn.checkbox')
            ->addColumn('edit', 'admin.laptop.btn.edit')
            ->addColumn('delete', 'admin.laptop.btn.delete')
            ->addColumn('laptop_image', function($query){

                $url = asset('storage/'.$query->laptop_image); 
    ...
    protected function getColumns()
    {
        return [
            ...
            'name'      => 'laptop_image',
            'data'      => 'laptop_image',
            'title'     => trans('admin.laptop_image'),
           ],[
            'name'  => 'edit',
            'data'  => 'edit',
